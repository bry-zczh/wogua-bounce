...
一个纯前端 Canvas 弹射清怪小游戏。玩家拖拽窝瓜蓄力，松手后反方向发射，在有限次数内通过反弹、炸弹桶、弹簧墙、传送门和风道清除所有怪物。
...
- 25 个内置关卡。
- 第 6-25 关提供路线提示按钮，后续关卡逐步组合弹簧、移动弹簧、炸弹、木箱、巡逻怪、传送门和风道。
- 关卡选择卡片展示每关核心机制，每页展示 8 个关卡并支持上一页/下一页切换。
- 地形怪物图鉴说明普通怪、头盔怪、巡逻怪、木箱、炸弹桶、弹簧墙、移动弹簧、传送门、风道、边界反弹和技能。
